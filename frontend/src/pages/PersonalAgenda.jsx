    ...
    <section className="agenda-page">
      <div className="agenda-header">
        ...
        <div className="agenda-actions">
          ...
          <div className="agenda-view-toggle" role="group" aria-label="Visualizacao da agenda">
      ...
      {newOpen && (
        <AgendaModal title="Novo compromisso" onClose={() => setNewOpen(false)}>
          <form className="agenda-form" onSubmit={(event) => { event.preventDefault(); setNewOpen(false); }}>
            ...
            <label className="wide">Observacao<textarea defaultValue="Ajustar conforme objetivo do aluno." /></label>
